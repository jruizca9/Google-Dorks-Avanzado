...
Buscar en un dominio específico
...
Palabra clave en el contenido del texto

filetype:

Buscar tipos de archivo (xls, doc, pdf...)
...
Búsqueda con operador lógico OR
